...
$(document).ready(function () {
  ...
  function start() {
    ...
    simonSequence = [];
    simon_fx = [
      new Audio("sounds/simon_red.mp3"),
      new Audio("sounds/simon_blue.mp3"),
      new Audio("sounds/simon_green.mp3"),
      new Audio("sounds/simon_yellow.mp3"),
    ];
    simonMove();
  }
  ...
  function compareSequences() {
    ...
    for (var i = 0; i < userSequence.length; i++) {
      if (
        simonSequence[i] == undefined ||
        simonSequence[i] != userSequence[i]
      ) {
        sequenceError = true;
        break;
      }
